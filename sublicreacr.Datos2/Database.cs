...
namespace sublicreacr.Datos
{
    ...
    {
        private static string strConnection = "Data Source=SQL5102.site4now.net;Initial Catalog=db_a87eb5_sublicr;User Id=db_a87eb5_sublicr_admin;Password=Admin123!";
